    ...
    return (
        ...
        <div id='LogInOut-sec'>
            <div id='LogInOut'>
                ...
                <span onMouseOver={onMouseOver} onMouseOut={onMouseOut} onClick={login} style={{ textAlign:'center', boxShadow: '0px 0px 15px 0px #094acd', borderRadius: '2vw', padding: '0.3vw', fontSize: '1.2vw', width:'15vw' }}><i className="fa fa-google"></i> <span id='LogInGoogle'>G</span>oogle
                </span>
            </div>
        </div>
    );
